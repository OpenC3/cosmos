...
function buildLanguageMode(HighlightRules, FoldMode) {
...
export function buildRubyMode() {
  const [oop, Mode] = buildLanguageMode(
...
export function buildPythonMode() {
  const [oop, Mode] = buildLanguageMode(
...
export function buildMarkdownMode() {
  const [oop, Mode] = buildLanguageMode(
...
// Legacy mixin export for backward compatibility
export default {
  methods: {
    buildLanguageMode,
    buildRubyMode,

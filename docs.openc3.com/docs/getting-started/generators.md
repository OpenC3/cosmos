...
| targets/GSE/lib/gse.rb              | Example library file which can be expanded as the target is developed. COSMOS recommends building up library methods to avoid code duplication and ease reuse.                                                                                                                                                                                                                                                                 |
...
| targets/GSE/procedures/procedure.rb | Procedure with an example of sending a command and checking telemetry                                                                                                                                                                                                                                                                                                                                                          |

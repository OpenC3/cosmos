...
This tutorial will use [VS Code](https://code.visualstudio.com) which is the editor used by the COSMOS developers. NOTE: There is a VS Code plugin maintained by a member of the COSMOS community at [openc3-vscode](https://github.com/JakeHillHub/openc3-vscode) (search in the Markplace for 'OpenC3').
:::

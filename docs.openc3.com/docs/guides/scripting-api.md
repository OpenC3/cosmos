...
| Method              | API        | Status                                                       |
| ------------------- | ---------- | ------------------------------------------------------------ |
| get_all_target_info | target_api | Removed, use [get_target_interfaces](#get_target_interfaces) |
...
| tlm_variable                          | Script Runner                | Deprecated, use [tlm](#tlm-tlm_raw-tlm_formatted) and pass type             |
...
| wait_raw                              | Script Runner                | Deprecated, use [wait](#wait) and pass type                                 |
| wait_check_raw                        | Script Runner                | Deprecated, use [wait_check](#wait_check) and pass type                     |
| wait_tolerance_raw                    | Script Runner                | Deprecated, use [wait_tolerance](#wait_tolerance) and pass type             |
| wait_check_tolerance_raw              | Script Runner                | Deprecated, use [wait_check_tolerance](#wait_check_tolerance) and pass type |

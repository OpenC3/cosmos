...
module OpenC3
  describe TriggerGroupMicroservice do
    ...
    # Copied from trigger_controller to simulate the notification generated by the controller
    def notify(json, kind:)
      notification = {
        'kind' => kind,
        'type' => 'trigger',
        'data' => JSON.generate(json),
      }
      AutonomicTopic.write_notification(notification, scope: 'DEFAULT')
    end
    ...
    describe "TriggerGroupMicroservice" do
      ...
      it "creates and deletes triggers and adds and removes corresponding topics" do
        ...
        notify(trig3.as_json(:allow_nan => true), kind: 'updated')
        trig3.update()
        sleep 0.1
        ...
        notify(trig3.as_json(:allow_nan => true), kind: 'deleted')
        sleep 0.1

  ...
  describe MqttInterface do
    ...
    describe "initialize" do
      it "sets all the instance variables" do
        i = MqttInterface.new('localhost', '1883', '10')
        ...
        expect(i.instance_variable_get(:@ack_timeout)).to eql 10.0
      end
    end
    ...
    describe "connect" do
      it "sets various ssl settings based on options" do
        ...
        expect(double).to receive(:ack_timeout=).with(5.0)
        ...
        i = MqttInterface.new('localhost', '1883', '5.0')

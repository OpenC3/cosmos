...
module OpenC3
  describe OpenC3 do
    ...
    DEPRECATED = %w(DONT_LOG REDUCED_MINUTE_LOG_RETAIN_TIME REDUCED_HOUR_LOG_RETAIN_TIME REDUCED_DAY_LOG_RETAIN_TIME REDUCED_LOG_RETAIN_TIME)
    DEPRECATED.concat(%w(REDUCER_DISABLE REDUCER_DISABLED REDUCER_MAX_CPU_UTILIZATION REDUCED_MAX_CPU_UTILIZATION))
    ...
    # GENERIC_CONVERSION is documented as GENERIC_READ_CONVERSION_START, GENERIC_WRITE_CONVERSION_START
    EXCEPTIONS.concat(%w(GENERIC_CONVERSION))

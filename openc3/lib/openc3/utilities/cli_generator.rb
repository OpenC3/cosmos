...
module OpenC3
  class CliGenerator
    ...
    def self.generate_target(args)
      ...
      target_class = target_lib_filename.filename_to_class_name # Used by ERB templates via binding
      target_object = target_name.downcase # Used by ERB templates via binding
...
RUBY
    ...
    def self.generate_microservice(args)
      ...
      microservice_class = microservice_filename.filename_to_class_name # Used by ERB templates via binding
    ...
    def self.generate_conversion(args)
      ...
      conversion_class = conversion_basename.filename_to_class_name # Used by ERB templates via binding
    ...
    def self.generate_processor(args)
      ...
      processor_class = processor_basename.filename_to_class_name # Used by ERB templates via binding
    ...
    def self.generate_limits_response(args)
      ...
      response_class = response_basename.filename_to_class_name # Used by ERB templates via binding
    ...
    def self.generate_command_validator(args)
      ...
      validator_class = validator_basename.filename_to_class_name # Used by ERB templates via binding

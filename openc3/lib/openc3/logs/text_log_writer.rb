    ...
    def close_file(take_mutex = true)
      ...
      begin
        ...
        @last_offsets.each do |redis_topic, last_offset|
          time = Time.now
          data = { time: time.to_nsec_from_epoch, '@timestamp' => time.xmlschema(3), level: 'INFO', "microservice_name" => Logger.microservice_name, "container_name" => @container_name, "last_offset" => last_offset, "redis_topic" => redis_topic, "type" => "offset" }

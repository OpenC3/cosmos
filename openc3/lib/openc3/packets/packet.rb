...
module OpenC3
  ...
  class Packet < Structure
    RESERVED_ITEM_NAMES = Set['PACKET_TIMESECONDS'.freeze, 'PACKET_TIMEFORMATTED'.freeze, 'RECEIVED_TIMESECONDS'.freeze, 'RECEIVED_TIMEFORMATTED'.freeze, 'RECEIVED_COUNT'.freeze, 'TIMESTAMP'.freeze, 'RX_TIMESTAMP'.freeze].freeze
    ANY_STATE = 'ANY'

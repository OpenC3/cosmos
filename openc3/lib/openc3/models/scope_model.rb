...
module OpenC3
  class ScopeModel < Model
    ...
    def undeploy
      ...
      unknown_shard = Store.shard_for_target('UNKNOWN', scope: @scope)
      Topic.del("#{@scope}__COMMAND__{UNKNOWN}__UNKNOWN", shard: unknown_shard)
      Topic.del("#{@scope}__TELEMETRY__{UNKNOWN}__UNKNOWN", shard: unknown_shard)

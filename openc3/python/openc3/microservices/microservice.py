...
class Microservice:
    ...
    def __init__(self, name, is_plugin=False):
        ...
        self.target_shard = int(self.config.get("target_shard", 0) or 0)
    ...
    def setup_microservice_topic(self):
        ...
        ephemeral_store_instance = EphemeralStore.instance(shard=self.target_shard)
    ...
    def microservice_cmd(self, topic, msg_id, msg_hash, _):
        ...
        if command == "ADD_TOPICS" and msg_hash.get("topics"):
            ...
            Topic.trim_topic(topic, msg_id, shard=self.target_shard)
            return True
        Topic.trim_topic(topic, msg_id, shard=self.target_shard)
        return False

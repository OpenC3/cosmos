...
class MetricModel(Model):
    ...
    def redis_metrics(cls):
        ...
        result["redis_ephemeral_commands_processed_total"] = metrics[
            "total_commands_processed"
        ]
        result["redis_ephemeral_iops"] = metrics["instantaneous_ops_per_sec"]
        result["redis_ephemeral_instantaneous_input_kbps"] = metrics[
            "instantaneous_input_kbps"
        ]
        result["redis_ephemeral_instantaneous_output_kbps"] = metrics[

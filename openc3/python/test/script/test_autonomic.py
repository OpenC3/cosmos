...
class TestAutonomic(unittest.TestCase):
    ...
    def test_autonomic_group_create(self, mock_api_server):
        ...
        mock_api_server.request.assert_called_with(
            'post', '/openc3-api/autonomic/group',
            data={"name": "test_group"}, json=True, scope='DEFAULT'
        )
    ...
    def test_autonomic_trigger_create(self, mock_api_server):
        ...
        mock_api_server.request.assert_called_with(
            'post', '/openc3-api/autonomic/test_group/trigger',
            data=expected_config, json=True, scope='DEFAULT'
        )
    ...
    def test_autonomic_trigger_update(self, mock_api_server):
        ...
        result = autonomic_trigger_update(
            "test_trigger",
            operator=operator,
            right=right,
            group="test_group"
        ...
        mock_api_server.request.assert_called_with(
            'put', '/openc3-api/autonomic/test_group/trigger/test_trigger',
            data=expected_config, json=True, scope='DEFAULT'
        )
    ...
    def test_autonomic_reaction_create(self, mock_api_server):
        ...
        result = autonomic_reaction_create(
            triggers=triggers,
            actions=actions,
            trigger_level='EDGE',
            snooze=0
        ...
        mock_api_server.request.assert_called_with(
            'post', '/openc3-api/autonomic/reaction',
            data=expected_config, json=True, scope='DEFAULT'
        )
    ...
    def test_autonomic_reaction_show(self, mock_api_server):
        ...
        mock_api_server.request.assert_called_with('get', '/openc3-api/autonomic/reaction/test_reaction', scope='DEFAULT')
        self.assertEqual(result, {"name": "test_reaction", "enabled": "true"})
    ...
    def test_autonomic_reaction_update(self, mock_api_server):
        ...
        result = autonomic_reaction_update(
            "test_reaction",
            trigger_level='LEVEL',
            snooze=300
        )
        ...
        mock_api_server.request.assert_called_with(
            'put', '/openc3-api/autonomic/reaction/test_reaction',
            data=expected_config, json=True, scope='DEFAULT'
        )

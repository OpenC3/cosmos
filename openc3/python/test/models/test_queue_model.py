...
class TestQueueModel(unittest.TestCase):
    ...
    def test_as_json(self):
        ...
        expected = {"name": "TEST", "scope": "DEFAULT", "state": "RUNNING", "updated_at": 1234567890}
    ...
    def test_list_empty(self, mock_store):
        ...
        mock_store.zrange.assert_called_once_with("DEFAULT:TEST", 0, -1, withscores=True)

    @patch("openc3.models.queue_model.Store")
    def test_list_with_items(self, mock_store):
        queue = QueueModel(name="TEST", scope="DEFAULT")
        mock_data = [('{"username": "user1", "value": "cmd1"}', 1.0), ('{"username": "user2", "value": "cmd2"}', 2.0)]
    ...
    def test_destroy(self, mock_store):
        ...
        with patch.object(queue, "undeploy"):

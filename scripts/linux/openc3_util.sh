...
saveTar() {
  ...
  docker pull $repo/$namespace/openc3-bucket$suffix:$tag
  ...
  docker save $repo/$namespace/openc3-bucket$suffix:$tag -o tmp/openc3-bucket$suffix-$tag.tar
...
loadTar() {
  ...
  docker load -i tmp/openc3-bucket$suffix-$tag.tar
...
tag() {
  ...
  docker tag $repo1/$namespace1/openc3-bucket$suffix:$tag1 $repo2/$namespace2/openc3-bucket$suffix:$tag2
...
push() {
  ...
  docker push $repo/$namespace/openc3-bucket$suffix:$tag

...
:save
  if "%5" == "" (
    ...
    docker pull !repo!/!namespace!/openc3-bucket:!tag! || exit /b
    ...
    docker save !repo!/!namespace!/openc3-bucket:!tag! -o tmp/openc3-bucket-!tag!.tar || exit /b
...
:load
  ...
  docker load -i tmp/openc3-bucket-!tag!.tar || exit /b
...
:tag
  ...
  docker tag !repo1!/!namespace1!/openc3-bucket:!tag1! !repo2!/!namespace2!/openc3-bucket:!tag2!
...
:push
  if "%5" == "" (
    ...
    docker push !repo!/!namespace!/openc3-bucket:!tag!
